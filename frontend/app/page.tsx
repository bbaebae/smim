        ...
        <div className={styles.sectionInner}>
          ...
          <div className={styles.contactGrid}>
            <div className={styles.contactInfo}>
              <div className={styles.contactItemsGroup}>
                {[
              ...
              <div className={styles.contactFaqDivider} />
              <div className={styles.contactFaqTitle}>자주 묻는 질문</div>
              {[
                ...
                <div key={i} className={styles.contactFaqItem}>
                  <div className={styles.contactFaqQ}>{faq.q}</div>
                  <div className={styles.contactFaqA}>{faq.a}</div>
                </div>
              ))}
            </div>
